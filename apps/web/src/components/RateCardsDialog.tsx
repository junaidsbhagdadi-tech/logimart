        ...
        {editing ? (
          ...
          <>
            <div className="row" style={{ justifyContent: 'flex-end', gap: 8, marginBottom: 12 }}>
              ...
              <button className="secondary" disabled={!cards.length} title="Printable rate sheet — use the browser's Save as PDF" onClick={async () => { (await import('../lib/rateSheet')).printRateCardsPdf(owner.name, cards); }}>🖨 PDF</button>
